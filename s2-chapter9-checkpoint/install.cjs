...
const home=path.join(root,'app/maths/s2/chapter-9/page.tsx'),lesson=path.join(root,'app/maths/s2/chapter-9/checkpoint/page.tsx'),patch=require('./homepage-patch.json');
