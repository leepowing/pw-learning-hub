...
const sections = [
  {
    number: 1,
    title: "Review on Areas of Polygons",
    description:
      "Review the area formulae for familiar polygons and calculate the areas of compound figures by splitting or filling.",
    route: "/maths/s1/chapter-7/areas-of-polygons",
    available: true,
  },
  {
    number: 2,
    title: "Volumes and Total Surface Areas of Prisms",
    description:
      "Identify the bases, lateral faces and height of a prism, then calculate its volume and total surface area.",
    route: "/maths/s1/chapter-7/prisms",
    available: true,
  },
];

export default function S1ChapterSevenPage() {
  ...
  return (
    <main className="page">
      ...
      <h1>Chapter 7 · Mensuration (I)</h1>

      <p className="introduction">
        Review areas of polygons and compound figures, then extend these ideas
        to the volumes and total surface areas of prisms.
      </p>

      <section className="overviewCard">
        <div className="overviewIcon">cm³</div>

        <div>
          <p className="overviewLabel">CHAPTER OVERVIEW</p>
          <h2>Measure two-dimensional and three-dimensional figures</h2>
          <p>
            Split or fill compound polygons using familiar shapes, and connect
            a prism&apos;s cross-section, length and lateral faces to its
      ...
      <section className="numberLineCard">
        <div className="numberLineHeading">
          <p>MENSURATION PREVIEW</p>
          <strong>Connect dimensions to area, volume and surface area</strong>
        </div>

        <div className="algebraExpression">V = A × h</div>

        <div className="comparisonExample">
          <span>TSA = 2A + Ph</span>
          <p>
            For a right prism, A is the base area, P is the base perimeter and
      ...
      <section className="keyIdeasStrip">
        <article>
          ...
          <p>Base multiplied by perpendicular height</p>
        </article>
        <article>
          <span>A = ½bh</span>
          <strong>Triangle</strong>
          <p>Half the product of base and height</p>
        </article>
        <article>
          <span>V = Ah</span>
          <strong>Prism volume</strong>
          <p>Base area multiplied by prism height</p>
        </article>
        <article>
          <span>TSA = 2A + Ph</span>
          <strong>Right prism</strong>
          <p>Two bases plus all lateral faces</p>
        </article>
      </section>
      ...
      <section className="rulesPreviewCard">
        <div>
          <p className="rulesPreviewLabel">COMPOUND FIGURES AND PRISMS</p>
          <h2>Break complex figures into familiar parts</h2>
          <p>
            Select a method that uses known area formulae and clearly labelled
            perpendicular dimensions.
          </p>
        </div>

        <div className="rulesGrid">
          <span>Split → add the component areas</span>
          <span>Fill → subtract the extra area</span>
          <span>Volume = base area × height</span>
          <span>Lateral area = base perimeter × height</span>
        </div>
      </section>

      <section className="featureCard flashcardCard">
        <div>
          <p className="featureLabel flashcardLabel">MENSURATION PRACTICE</p>
          <h2>Chapter 7 Flashcards</h2>
          <p>
            Practise polygon area formulae, compound-area methods, prism
            vocabulary, volume and total surface area.
          </p>
        </div>
        ...
        <button
          ...
          onClick={() =>
            router.push("/maths/flashcards?level=s1&chapter=7")
          }
        >
          Open Flashcards →
        </button>
      ...
      <section className="featureCard checkpointCard">
        ...
        <button
          ...
          onClick={() => router.push("/maths/s1/chapter-7/checkpoint")}
        >
          Start Checkpoint →
        </button>
      </section>
