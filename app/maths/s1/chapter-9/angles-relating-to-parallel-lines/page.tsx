...
function ParallelDiagram({kind}:{kind:DiagramKind}){return <Parallel kind={kind}/>;}

function ConverseDiagram({kind}:{kind:DiagramKind}){return <Parallel kind={kind} converse names/>;}
