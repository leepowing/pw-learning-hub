...
function SimilarPairDiagram(){return <Pair mode="aaa"/>;}

function ScaleFactorDiagram(){return <Pair mode="scale2"/>;}

function WorkedExampleDiagram(){return <Pair mode="worked-similar"/>;}
