...
function PairedTrianglesDiagram({kind}:{kind:DiagramKind}){return <Pair mode={kind==="sss"?"sss":kind==="sas"?"sas":kind==="aaa"||kind==="aaa-not-congruent"?"aaa":kind==="similarity-order"?"similar":"plain"} names={kind==="similarity-order"?["P","Q","R","S","T","U"]:undefined}/>;}

function RhsDiagram(){return <Pair mode="rhs"/>;}

function ProportionalDiagram({kind}:{kind:DiagramKind}){return <Pair mode={kind==="scale-factor"?"scale3":kind==="missing-side"?"missing":"proportional"}/>;}

function SasProportionalDiagram(){return <Pair mode="worked-sas"/>;}
