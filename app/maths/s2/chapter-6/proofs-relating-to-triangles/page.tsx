...
const questions = [
  { id: "sum", prompt: "Two interior angles of a triangle are 48° and 67°. Find the third angle.", options: ["115°", "65°", "245°"], answer: 1, explanation: "The three interior angles sum to 180°. The third angle is 180° − 48° − 67° = 65°." },
  { id: "remote", prompt: "An exterior angle of a triangle is 128°. One of its two remote interior angles is 53°. Find the other remote interior angle.", options: ["75°", "52°", "181°"], answer: 0, explanation: "The exterior angle equals the sum of the two remote interior angles. The missing angle is 128° − 53° = 75°. The adjacent interior angle would be 52°." },
  { id: "exterior", prompt: "B, C and D are collinear in that order. In triangle ABC, ∠A = a, ∠B = b and ∠C = c. Which expression equals ∠ACD?", options: ["a + b + c", "b + c", "a + b"], answer: 2, explanation: "∠ACD is the exterior angle at C. Its remote interior angles are a and b; c is adjacent to it. Hence ∠ACD = a + b." },
  ...
  return <main className="trianglesPage">
    ...
    <section className="lessonCard">
      ...
      <div className="factGrid">
        <article className="factTile"><h3>Interior angles of a triangle</h3><SumDiagram /><p className="factEquation">a + b + c = 180°</p><p>Count the three angles inside the triangle, one at each vertex.</p><p className="reference">[Reference: ∠ sum of △]</p></article>
        <article className="factTile"><h3>Exterior angle of a triangle</h3><ExteriorDiagram /><p className="factEquation">e = a + b</p><p>B, C and D are collinear in that order. Extending BC to D creates exterior angle e = ∠ACD.</p><p className="reference">[Reference: ext. ∠ of △]</p></article>
      </div>
    ...
    <section className="lessonCard workedCard" aria-labelledby="sumProofTitle">
      ...
      {stage === 2 && <div className="sumProof"><Proof caption="Proof using a parallel line through A" rows={[
        ...
        ["∠DAB = ∠ABC = b", "Alternate angles, DE // BC; transversal AB."],
        ["∠CAE = ∠ACB = c", "Alternate angles, DE // BC; transversal AC."],
        ["∠DAB + ∠BAC + ∠CAE = 180°", "Adjacent angles on straight line DAE."],
    ...
    <section className="lessonCard">
      ...
      <Proof caption="Proof of the exterior-angle theorem" rows={[
        ["a + b + c = 180°", "Angle sum of triangle ABC."],
        ["c + e = 180°", "Adjacent angles on straight line BCD."],
    ...
    <section className="lessonCard">
      ...
      <details className="solution"><summary>Reveal the perpendicular-side proof</summary><div className="solutionBody"><Proof caption="From the triangle angle sum to perpendicular sides" rows={[
        ["2x + 3x + x = 180°", "Angle sum of triangle ABC."], ["6x = 180°", "Collect like terms."], ["x = 30°", "Divide both sides by 6."], ["∠ABC = 3x = 90°", "Substitute x = 30°."], ["∴ AB ⟂ BC", "Definition of perpendicular lines."]
      ]} /></div></details>
    </section>
    ...
    <section className="lessonCard workedCard">
      ...
      <details className="solution"><summary>Reveal the angle calculation</summary><div className="solutionBody"><Proof caption="Calculate x and y with a reason for each step" rows={[
        ["x = 64° + 48° = 112°", "Exterior angle of triangle ABC."], ["x + y = 180°", "Adjacent angles on straight line BCD."], ["y = 180° − 112° = 68°", "Substitute x, then subtract."], ["∴ x = 112° and y = 68°", "The two required angles."]
    ...
    <section className="lessonCard">
      ...
      <details className="solution"><summary>Reveal the parallel-line proof</summary><div className="solutionBody"><Proof caption="An exterior angle followed by a parallel-line converse" rows={[
        ["a + b = x", "Given."], ["∠BCD = e = a + b", "Exterior angle of triangle ABC; AC is extended to D."], ["∠BCD = x = ∠ADE", "Substitute the given equality and angle label."], ["∴ BC // DE", "Alternate angles ∠BCD and ∠ADE are equal; transversal AD."]
      ]} /></div></details>
