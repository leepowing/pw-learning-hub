...
type VisualMathsFlashcard = MathsFlashcard & {
  ...
  s2Chapter11Diagram?: S2Chapter11DiagramKind;
  s2Chapter10Diagram?: S2Chapter10DiagramKind;
  s2Chapter9Diagram?: S2Chapter9DiagramKind;
  s2Chapter8Diagram?: S2Chapter8DiagramKind;
      ...
      >
        <div style={{ position: "relative", display: useContentSizedFaces ? "grid" : undefined, minHeight: hasFrontVisual ? 560 : 430, transformStyle: "preserve-3d", transform: flipped ? "rotateY(180deg)" : "rotateY(0deg)", transition: "transform 500ms ease" }}>
          <article style={{ ...cardFace("linear-gradient(135deg, #eef2ff, #ffffff)", "#c7d2fe"), ...(useContentSizedFaces ? { position: "relative" as const, inset: "auto", gridArea: "1 / 1", minWidth: 0, padding: "clamp(18px, 4vw, 34px)" } : {}) }}>
            ...
            {currentCard.s2Chapter11Diagram && <S2Chapter11FlashcardDiagram kind={currentCard.s2Chapter11Diagram} />}
            {currentCard.s2Chapter10Diagram && <S2Chapter10FlashcardDiagram kind={currentCard.s2Chapter10Diagram} />}
            {currentCard.s2Chapter9Diagram && <S2Chapter9FlashcardDiagram kind={currentCard.s2Chapter9Diagram} />}
            {currentCard.s2Chapter8Diagram && <S2Chapter8FlashcardDiagram kind={currentCard.s2Chapter8Diagram} />}
